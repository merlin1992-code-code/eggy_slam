 ...
 * @LastEditTime: 2025-07-09 13:10:14
 */
#pragma once
#include "commons.h"
#include "blam.h"
...
public:
    ...
    void insert(pcl::PointCloud<pcl::PointXYZI>::Ptr &cloud, const Pose &pose, const std::string& filename ="");
    ...
    void writeJsonPoses(const std::string &path);
