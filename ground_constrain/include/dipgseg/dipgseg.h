...
#include <cmath>
    ...
    public:
        ...
        Dipgseg(const LidarParam &param);
        ~Dipgseg();
    ...
    private:
        ...
        double close_region_boundary_x_neg;
        double close_region_boundary_x_pos;
        double close_region_boundary_y;
    ...
    Dipgseg::Dipgseg(const LidarParam &param)
        : row_angles_size(param.row_angles_size),
          col_angles_size(param.col_angles_size),
          cpst(param.cpst),
          cpst_d_th(param.cpst_d_th),
          sensor_height(param.sensor_height),
          close_region_boundary_x_neg(param.close_region_boundary_x_neg),
          close_region_boundary_x_pos(param.close_region_boundary_x_pos),
          close_region_boundary_y(param.close_region_boundary_y),
          unprj_row_angles_const(param.unprj_row_angles_const),
          unprj_col_angles_const(param.unprj_col_angles_const),
          reverse_step_row_angle(param.reverse_step_row_angle),
          reverse_step_col_angle(param.reverse_step_col_angle),
          half_row_angle_step(param.half_row_angle_step),
          half_col_angle_step(param.half_col_angle_step),
          first_index(param.first_index),
          last_rows_index(param.last_rows_index),
          last_cols_index(param.last_cols_index),
          upper_z_std_thr(0.2), lower_z_std_thr(0.03),
          edge_z_hori_thr(0.05),
          upper_slope_thr(0.577), lower_slope_thr(0.268),
          upper_flatness_thr(0.289), lower_flatness_thr(0.134),
          pcount_ground_thr(6), pcount_non_ground_thr(8)
    ...
    Dipgseg::Dipgseg(double upper_z_std_thr, double lower_z_std_thr,
                     ...
                     double upper_slope_thr,
                     double lower_slope_thr, double upper_flatness_thr,
                     double lower_flatness_thr) : upper_z_std_thr(upper_z_std_thr), lower_z_std_thr(lower_z_std_thr),
